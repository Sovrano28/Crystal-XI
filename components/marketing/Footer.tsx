...
export function Footer() {
  ...
  return (
    <footer className="bg-[var(--background-secondary)] border-t border-[var(--surface-border)]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-[var(--foreground-muted)] mb-4">
              Plan your FPL team across all future gameweeks. Make smarter transfer decisions.
            </p>
            {/* Social Links */}
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  href={social.href}
                  className={cn(
                    'text-[var(--foreground-muted)] hover:text-[var(--pl-magenta)]',
        ...
        <div className="pt-8 border-t border-[var(--surface-border)]">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-[var(--foreground-muted)]">
              © {new Date().getFullYear()} Crystal XI. All rights reserved.
            </p>
