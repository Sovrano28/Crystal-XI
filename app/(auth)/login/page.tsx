...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="absolute top-0 -left-32 w-96 h-96 bg-[var(--pl-magenta)] rounded-full opacity-20 blur-[120px] animate-pulse" />
      <div className="absolute bottom-0 -right-32 w-96 h-96 bg-[var(--pl-cyan)] rounded-full opacity-15 blur-[120px] animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                className="w-4 h-4 rounded border-[var(--surface-border)] text-[var(--pl-magenta)] focus:ring-[var(--pl-magenta)]"
              />
              <span className="text-sm text-[var(--foreground-muted)]">Remember me</span>
            </label>
            <a
              href="#"
              className="text-sm text-[var(--pl-magenta)] hover:text-[var(--pl-magenta-light)] transition-colors"
            >
              Forgot password?
            </a>
          </div>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-[var(--surface-elevated)] text-[var(--foreground-muted)]">
              Or continue with
            </span>
          </div>
        </div>
